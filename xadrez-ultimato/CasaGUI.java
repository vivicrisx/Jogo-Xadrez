...
public class CasaGUI extends JButton {
    ...
    public  int getCorPeca() {
        ...
        if (icone == PEAO_BRANCO ||icone == TORRE_BRANCA ||icone == RAINHA_BRANCA || icone == REI_BRANCO ||icone == BISPO_BRANCO || icone == CAVALO_BRANCO) {
            return PECA_BRANCA;
        }
        else if (icone == PEAO_PRETO ||icone == TORRE_PRETA ||icone == RAINHA_PRETA || icone == REI_PRETO ||icone == BISPO_PRETO || icone == CAVALO_PRETO) {
             return PECA_PRETA;
        }
        else {
            return SEM_PECA;
